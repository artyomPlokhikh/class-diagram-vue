<template>
    <defs>
        ...
        <marker id="filled_diamond" markerWidth="10" markerHeight="10" refX="0" refY="5" orient="auto">
            <path d="M10,5 L5,0 L0,5 L5,10 Z" fill="black"/>
        </marker>
        ...
        <marker id="open_triangle" markerWidth="10" markerHeight="10" refX="10" refY="5" orient="auto">
            <path d="M0,0 L10,5 L0,10 Z" fill="none" stroke="black"/>
        </marker>
